...
class TestLevelStore:
    ...
    def test_opening_range_formation(self, nyc_tz):
        ...
        ticks = [
            Tick(
                symbol="ES",
                timestamp=datetime(2024, 1, 3, 9, 30, tzinfo=nyc_tz),
                price=Decimal("5000.00"),
                volume=100,
            ),
            Tick(
                symbol="ES",
                timestamp=datetime(2024, 1, 3, 9, 35, tzinfo=nyc_tz),
                price=Decimal("5010.00"),
                volume=100,
            ),
            Tick(
                symbol="ES",
    ...
    def test_vwap_calculation(self, nyc_tz):
        ...
        ticks = [
            ...
            Tick(
                symbol="ES",
                timestamp=datetime(2024, 1, 3, 9, 31, tzinfo=nyc_tz),
                price=Decimal("110"),
                volume=10,
            ),
        ]
...
class TestInteractionDetector:
    ...
    def test_break_and_hold(self, nyc_tz):
        ...
        detector.on_bar_close(
            Decimal("5101.00"), datetime(2024, 1, 3, 10, 1, tzinfo=nyc_tz)
        )  # Break
        ...
        break_holds = [
            i for i in interactions if i.interaction_type == InteractionType.BREAK_AND_HOLD
        ]
